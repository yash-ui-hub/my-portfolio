...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Yash — Developer & Founder" },
      { name: "description", content: "Premium portfolio of Yash — developer, entrepreneur and founder of Core Creation." },
      { name: "author", content: "Yash" },
      { property: "og:title", content: "Yash — Developer & Founder" },
      { property: "og:description", content: "Premium portfolio of Yash — developer, entrepreneur and founder of Core Creation." },
